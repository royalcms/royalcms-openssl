<?php namespace Royalcms\Component\Openssl\Url;

use Royalcms\Component\Openssl\Url;
use Royalcms\Component\Openssl\Certificate\Chain\Validator;
...
class Validator
{
    ...
    public function validate()
    {
        ...
        $urlChainValidator = new Validator($urlChain);
