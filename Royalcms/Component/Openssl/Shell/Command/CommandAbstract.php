 ...
 *
 * @throws \Royalcms\Component\Openssl\Shell\Command\CommandException
 */
abstract class CommandAbstract implements CommandInterface
{
     ...
     * @throws \Royalcms\Component\Openssl\Shell\Command\CommandException
     * @param  string                  $stdIn
     * @return \Royalcms\Component\Openssl\Shell\Command\CommandAbstract
     */
    public function execute($stdIn = "")
    {
        ...
        if (fwrite($pipes[0], $stdIn) === FALSE) {
            throw new CommandException('Failed to write certificate for pipe.');
        }
        fclose($pipes[0]);
